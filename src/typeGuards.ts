...
export function isProject(obj: unknown): obj is Project {
  ...
  return (
    ...
    typedObj["workbenches"].every((e: any) =>
      isWorkBench(e) as boolean
    )
  )
}
...
export function isWorkBench(obj: unknown): obj is WorkBench {
  ...
  return (
    ...
    typedObj["history"].every((e: any) =>
      isHistoryStep(e) as boolean
    ) &&
    (typedObj["step_counters"] !== null &&
      typeof typedObj["step_counters"] === "object" ||
...
export function isPreviewGeometry(obj: unknown): obj is PreviewGeometry {
  ...
  return (
    (typedObj !== null &&
      ...
      typeof typedObj === "function") &&
    isEntityType(typedObj["type"]) as boolean &&
    (typeof typedObj["start"] === "undefined" ||
      isPointLikeById(typedObj["start"]) as boolean) &&
    (typeof typedObj["end"] === "undefined" ||
      isPointLikeById(typedObj["end"]) as boolean) &&
    (typeof typedObj["center"] === "undefined" ||
      isPointLikeById(typedObj["center"]) as boolean) &&
    (typeof typedObj["radius"] === "undefined" ||
...
export function isPlane(obj: unknown): obj is Plane {
  ...
  return (
    ...
    (typedObj["secondary"] !== null &&
      typeof typedObj["secondary"] === "object" ||
    ...
    (typedObj["tertiary"] !== null &&
      typeof typedObj["tertiary"] === "object" ||
...
export function isPointsById(obj: unknown): obj is PointsById {
  ...
  return (
    (typedObj !== null &&
      ...
      typeof typedObj === "function") &&
    Object.entries<any>(typedObj)
      .every(([key, value]) => (isPointById(value) as boolean &&
        typeof key === "string"))
  )
}
...
export function isPointsLikeById(obj: unknown): obj is PointsLikeById {
  ...
  return (
    (typedObj !== null &&
      ...
      typeof typedObj === "function") &&
    Object.entries<any>(typedObj)
      .every(([key, value]) => (isPointLikeById(value) as boolean &&
        typeof key === "string"))
  )
}
  ...
  return (
    ...
    ((typedObj["data"] !== null &&
      ...
      (typedObj["data"] !== null &&
        ...
        typeof typedObj["data"] === "function") &&
      isHistoryStepType(typedObj["data"]["type"]) as boolean &&
      (typedObj["data"]["extrusion"] !== null &&
        typeof typedObj["data"]["extrusion"] === "object" ||
      ...
      typedObj["data"]["extrusion"]["face_ids"].every((e: any) =>
        typeof e === "number"
      ) &&
      ...
      typeof typedObj["data"]["width"] === "number" &&
      typeof typedObj["data"]["height"] === "number" &&
      (typedObj["data"]["sketch"] !== null &&
        typeof typedObj["data"]["sketch"] === "object" ||
        typeof typedObj["data"]["sketch"] === "function") &&
      (typedObj["data"]["sketch"]["points"] !== null &&
      ...
      Object.entries<any>(typedObj["data"]["sketch"]["line_segments"])
        .every(([key, value]) => (isSegmentId(value) as boolean &&
          typeof key === "string")) &&
      ...
      Object.entries<any>(typedObj["data"]["sketch"]["circles"])
        .every(([key, value]) => (isCircle(value) as boolean &&
          typeof key === "string")) &&
...
export function isPointHistoryStep(obj: unknown): obj is PointHistoryStep {
  ...
  return (
    isHistoryStep(typedObj) as boolean &&
    isPointData(typedObj) as boolean
  )
}
...
export function isPlaneHistoryStep(obj: unknown): obj is PlaneHistoryStep {
  ...
  return (
    isHistoryStep(typedObj) as boolean &&
    isPlaneData(typedObj) as boolean
  )
}
...
export function isExtrusionHistoryStep(obj: unknown): obj is ExtrusionHistoryStep {
  ...
  return (
    isHistoryStep(typedObj) as boolean &&
    isExtrusionData(typedObj) as boolean
  )
}
...
export function isSketchHistoryStep(obj: unknown): obj is SketchHistoryStep {
  ...
  return (
    isHistoryStep(typedObj) as boolean &&
    isSketchData(typedObj) as boolean
  )
}
...
export function isSketchRealized(obj: unknown): obj is SketchRealized {
  ...
  return (
    ...
    (typedObj["line_segments"] !== null &&
      typeof typedObj["line_segments"] === "object" ||
      typeof typedObj["line_segments"] === "function") &&
    Object.entries<any>(typedObj["line_segments"])
      .every(([key, value]) => (isSegmentId(value) as boolean &&
        typeof key === "string")) &&
    typeof typedObj["highest_line_segment_id"] === "number" &&
    (typedObj["circles"] !== null &&
      typeof typedObj["circles"] === "object" ||
      typeof typedObj["circles"] === "function") &&
    Object.entries<any>(typedObj["circles"])
      .every(([key, value]) => (isCircle(value) as boolean &&
        typeof key === "string")) &&
    typeof typedObj["highest_circle_id"] === "number" &&
    (typedObj["arcs"] !== null &&
      typeof typedObj["arcs"] === "object" ||
      typeof typedObj["arcs"] === "function") &&
    Object.entries<any>(typedObj["arcs"])
      .every(([key, value]) => (isArc(value) as boolean &&
        typeof key === "string")) &&
...
export function isTruckNurbsSurfaceControlPoints(obj: unknown): obj is TruckNurbsSurfaceControlPoints {
  ...
  return (
    ...
    typedObj.every((e: any) =>
      isTruckNurbsSurfaceControlPoint(e) as boolean
    )
  )
}
...
export function isTruckNurbsSurface(obj: unknown): obj is TruckNurbsSurface {
  ...
  return (
    (typedObj !== null &&
      typeof typedObj === "object" ||
      typeof typedObj === "function") &&
    (typedObj["NURBSSurface"] !== null &&
      typeof typedObj["NURBSSurface"] === "object" ||
      typeof typedObj["NURBSSurface"] === "function") &&
    Array.isArray(typedObj["NURBSSurface"]["knot_vecs"]) &&
    typedObj["NURBSSurface"]["knot_vecs"].every((e: any) =>
      Array.isArray(e) &&
      e.every((e: any) =>
        typeof e === "number"
      )
...
export function isTruckPlane(obj: unknown): obj is TruckPlane {
  ...
  return (
    (typedObj !== null &&
      ...
      typeof typedObj === "function") &&
    (typedObj["Plane"] !== null &&
      typeof typedObj["Plane"] === "object" ||
      typeof typedObj["Plane"] === "function") &&
    (typedObj["Plane"]["o"] !== null &&
      typeof typedObj["Plane"]["o"] === "object" ||
    ...
    (typedObj["Plane"]["p"] !== null &&
      typeof typedObj["Plane"]["p"] === "object" ||
    ...
    (typedObj["Plane"]["q"] !== null &&
      typeof typedObj["Plane"]["q"] === "object" ||
...
export function isTruckSurface(obj: unknown): obj is TruckSurface {
  ...
  return (
    (isTruckNurbsSurface(typedObj) as boolean ||
      isTruckPlane(typedObj) as boolean)
  )
}
...
export function isTruckFaceBoundary(obj: unknown): obj is TruckFaceBoundary {
  ...
  return (
    Array.isArray(typedObj) &&
    typedObj.every((e: any) =>
      isTruckFaceEdgeIndex(e) as boolean
    )
  )
}
...
export function isTruckFace(obj: unknown): obj is TruckFace {
  ...
  return (
    ...
    typedObj["boundaries"].every((e: any) =>
      isTruckFaceBoundary(e) as boolean
    ) &&
...
export function isTruckNurbsCurve(obj: unknown): obj is TruckNurbsCurve {
  ...
  return (
    (typedObj !== null &&
      typeof typedObj === "object" ||
      typeof typedObj === "function") &&
    (typedObj["NURBSCurve"] !== null &&
      typeof typedObj["NURBSCurve"] === "object" ||
      typeof typedObj["NURBSCurve"] === "function") &&
    Array.isArray(typedObj["NURBSCurve"]["knot_vec"]) &&
    typedObj["NURBSCurve"]["knot_vec"].every((e: any) =>
      typeof e === "number"
    ) &&
    Array.isArray(typedObj["NURBSCurve"]["control_points"]) &&
    typedObj["NURBSCurve"]["control_points"].every((e: any) =>
      isTruckNurbsPoint(e) as boolean
    )
  )
}
...
export function isTruckLineVectors(obj: unknown): obj is TruckLineVectors {
  ...
  return (
    Array.isArray(typedObj) &&
    (typedObj[0] !== null &&
      typeof typedObj[0] === "object" ||
      typeof typedObj[0] === "function") &&
    typeof typedObj[0]["x"] === "number" &&
    typeof typedObj[0]["y"] === "number" &&
    typeof typedObj[0]["z"] === "number" &&
    (typedObj[1] !== null &&
      typeof typedObj[1] === "object" ||
      typeof typedObj[1] === "function") &&
...
export function isTruckCurve(obj: unknown): obj is TruckCurve {
  ...
  return (
    (isTruckNurbsCurve(typedObj) as boolean ||
      isTruckLine(typedObj) as boolean)
  )
}
...
export function isRealization(obj: unknown): obj is Realization {
  ...
  return (
    (typedObj !== null &&
      typeof typedObj === "object" ||
      typeof typedObj === "function") &&
    (typedObj["planes"] !== null &&
      typeof typedObj["planes"] === "object" ||
      typeof typedObj["planes"] === "function") &&
    Object.entries<any>(typedObj["planes"])
      .every(([key, value]) => (isPlaneRealized(value) as boolean &&
        typeof key === "string")) &&
    (typedObj["points"] !== null &&
      typeof typedObj["points"] === "object" ||
      typeof typedObj["points"] === "function") &&
    ...
    Object.entries<any>(typedObj["sketches"])
      .every(([key, value]) => (isSketchTuple(value) as boolean &&
        typeof key === "string")) &&
    (typedObj["solids"] !== null &&
      typeof typedObj["solids"] === "object" ||
      typeof typedObj["solids"] === "function") &&
    Object.entries<any>(typedObj["solids"])
      .every(([key, value]) => (isSolidRealized(value) as boolean &&
        typeof key === "string"))
  )
}
...
export function isTruckBoundary(obj: unknown): obj is TruckBoundary {
  ...
  return (
    ...
    typedObj["edges"].every((e: any) =>
      isTruckEdge(e) as boolean
    ) &&
    Array.isArray(typedObj["faces"]) &&
    typedObj["faces"].every((e: any) =>
      isTruckFace(e) as boolean
    )
  )
}
...
export function isDeleteCircles(obj: unknown): obj is DeleteCircles {
  ...
  return (
    ...
    typedObj["circle_ids"].every((e: any) =>
      typeof e === "number"
    )
  )
}
