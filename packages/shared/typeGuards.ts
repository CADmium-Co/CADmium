	...
	return (
		...
		((((typedObj["data"] !== null && typeof typedObj["data"] === "object") || typeof typedObj["data"] === "function") &&
			...
			(((typedObj["data"] !== null && typeof typedObj["data"] === "object") ||
				...
				Object.entries<any>(typedObj["data"]["sketch"]["points"]).every(
				...
				Object.entries<any>(typedObj["data"]["sketch"]["line_segments"]).every(
				...
				Object.entries<any>(typedObj["data"]["sketch"]["circles"]).every(
...
export function isSketchRealized(obj: unknown): obj is SketchRealized {
	...
	return (
		...
		Object.entries<any>(typedObj["points"]).every(
		...
		Object.entries<any>(typedObj["points_2d"]).every(
			([key, value]) => (isPoint2D(value) as boolean) && typeof key === "string"
		) &&
		...
		Object.entries<any>(typedObj["line_segments"]).every(
			([key, value]) => (isSegmentId(value) as boolean) && typeof key === "string"
		) &&
...
export function isRealization(obj: unknown): obj is Realization {
	...
	return (
		...
		Object.entries<any>(typedObj["planes"]).every(
		...
		Object.entries<any>(typedObj["sketches"]).every(
		...
		Object.entries<any>(typedObj["solids"]).every(
