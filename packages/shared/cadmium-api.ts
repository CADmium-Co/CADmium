...
export interface WorkbenchPointAdd {
  workbench_id: IDType
  x: number
  y: number
  z: number
...
export interface WorkbenchPlaneAdd {
  workbench_id: IDType
  plane: Plane
  width: number
  height: number
...
export interface WorkbenchSketchAdd {
  workbench_id: IDType
...
export interface WorkbenchSketchSetPlane {
  workbench_id: IDType
  sketch_id: IDType
  plane_description: PlaneDescription
}
...
export interface WorkbenchPointUpdate {
  workbench_id: IDType
  point_id: IDType
  x: number
  y: number
...
export interface SketchAddPoint {
  workbench_id: IDType
  sketch_id: IDType
  x: number
  y: number
...
export interface SketchAddCircle {
  workbench_id: IDType
  sketch_id: IDType
  center: IDType
  radius: number
...
export interface SketchAddLine {
  workbench_id: IDType
  sketch_id: IDType
  start: IDType
  end: IDType
...
export interface SketchAddRectangle {
  workbench_id: IDType
  sketch_id: IDType
  start: IDType
  end: IDType
...
export interface SketchDeleteCompound {
  workbench_id: IDType
  sketch_id: IDType
  id: IDType
}
...
export interface SketchDeletePrimitive {
  workbench_id: IDType
  sketch_id: IDType
  id: IDType
}
...
export interface FeatureExtrusionAdd {
  workbench_id: IDType
  sketch_id: IDType
  faces: IDType[]
  length: number
...
export interface FeatureExtrusionUpdateFaces {
  workbench_id: IDType
  extrusion_id: IDType
  sketch_id: IDType
  faces: IDType[]
...
export interface FeatureExtrusionUpdateForm {
  workbench_id: IDType
  feature_id: IDType
  length: number
  offset: number
